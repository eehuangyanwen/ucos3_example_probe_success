...
*			- IAR v6.20 or later
*			- Keil MDK 礦ision4 v4.54 or later
...
typedef struct
{
 CPU_INT08U USER_EXTI_PortSourceGPIOx;
 CPU_INT08U USER_EXTI_PinSourcex;
 CPU_INT32U USER_NVIC_PriorityGroup;
 EXTI_InitTypeDef USER_EXTI_InitStruct;
 NVIC_InitTypeDef USER_NVIC_InitStruct;
}EXIT_ConfigTypeDef;
...
void  BSP_IntHandler_EXTI0_PA0 (void);  //没有static，所有文件均可访问这个函数，但需要将这个声明放在.h文件，使用时#include
